...
def patient_signup():
    ...
    if not isinstance(name, str) or not isinstance(blood_group, str) or not isinstance(conditions, str) or not isinstance(phone, str) or not isinstance(email, str) or not isinstance(password, str):
